...
image_name = "receipt_test"
txt_path = "C:/Users/joerr/Desktop/新增資料夾 (2)/receipt_test.txt"
...
print(txt_content , "has been read successfully!")
#print(txt_content)
...
print("Raw text has been extracted successfully!")
#print(raw_text)
...
#print(type(parsed_data))  # list
#print(parsed_data)
print("Txt to JSON has been done successfully!")

output_path = r"C:\Users\joerr\Documents\GitHub\self-initiative-project-2\{}.json".format(image_name)

with open(output_path, 'w' , encoding="utf-8") as json_file:
    json.dump(parsed_data, json_file, ensure_ascii=False, indent=2)

print(txt_content,"has been transformed to JSON file")


#receipt jpg > OCR to txt > txt to JSON > merge new items to the original one 
# save jpg      save txt     save output 